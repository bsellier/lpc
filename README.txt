...
#Guide d'ouverture de l'application 
_____________________________________
- L'application suivant est un prototype et pour le faire fonctionner, des compétences en informatiques sont nécessaires.
...
commande contenu dans le fichier pour implementer cette bdd;
...
Elles sont dans les fichiers .ui et on y travaille directement grâce à la bibliothèque PyQt5 de python. 


Pour des questions ultérieures sur certaines fonctions, vous pouvez envoyer un mail aux adresses mail suivants:
- zebberomeo@yahoo.fr
- 